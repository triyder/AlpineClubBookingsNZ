...
- Admin > Image Manager uploads filesystem images into the shared
  ...
  A single upload batch is capped at 25 files and an 80MB total request body. SVG
  is intentionally rejected there because filesystem uploads are served as static
