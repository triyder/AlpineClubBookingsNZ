...
const faqContentHtml = [
  ...
  `<div><h2>Membership</h2><details><summary>How do I become a member?</summary><p>Membership is by nomination. You need to be nominated by two existing financial members. Start by visiting the lodge as someone's guest, get to know some members, and ask if they'd be willing to nominate you. See the Join page for the full process.</p></details><details><summary>What does membership cost?</summary><p>There is a one-off joining fee for new members, plus an Annual Membership Fee. Subscriptions run April to March and are invoiced through Xero. Family memberships cover all household members at a reduced combined rate. Contact the Treasurer for current fee amounts.</p></details><details><summary>When does the membership year run?</summary><p>The membership year runs from 1 April to 31 March. Annual Membership Fees are due at the start of each year. Members with unpaid subscriptions lose access to member booking rates until their subscription is paid.</p></details><details><summary>How do I reset my password?</summary><p>Click "Forgot password?" on the login page and enter your email address. You'll receive a password reset link valid for one hour. If you don't receive the email, check your spam folder or contact the Booking Officer.</p></details></div>`,
