...
// 20260613090000_update_starter_home_page_content, and
// 20260702090000_backfill_policy_page_content migrations. The migrations
...
const privacyPolicyContentHtml = [
  ...
  `<div><h2>9. Cookies and Tracking</h2><p>This System uses a single session cookie to keep you logged in. This cookie contains an encrypted session token and no personal information. We do not use advertising cookies, third-party tracking, or analytics cookies. The session cookie expires after 8 hours of inactivity or when you sign out.</p></div>`,
...
const termsOfServiceContentHtml = [
  ...
  `<div><h2>3. Booking Rules</h2><ul><li>Lodge bookings are for accommodation at Waldvogel Lodge, Iwikau Village, Mt Ruapehu. The lodge sleeps a maximum of {{lodge-capacity}} guests.</li><li>Bookings must be made through the System. Verbal or informal bookings are not accepted.</li><li>Members may book for themselves and invite non-member guests. The booking member must be present during the stay of any non-member guests.</li><li>Non-member bookings more than 7 days in advance are held as &ldquo;Pending&rdquo; and may be bumped if capacity is required for member bookings. See Section 5 for details.</li><li>All guests must participate in the lodge chore roster. Chore assignments are allocated by the hut leader for each night.</li><li>Guests must treat the lodge, equipment, and other guests with respect. The committee reserves the right to refuse future bookings to guests who cause damage or behave inappropriately.</li><li>The lodge is a shared facility. Quiet hours are from 10pm to 7am. Alcohol consumption must be responsible and is not permitted in common areas after quiet hours.</li></ul></div>`,
  `<div><h2>4. Payment Terms</h2><ul><li>Lodge accommodation fees are charged per person per night based on age group and membership status. Current rates are published on the <a href="/join">Join page</a>.</li><li>For confirmed bookings (members only, or bookings within 7 days of check-in), payment is collected immediately via Stripe at the time of booking.</li><li>For pending bookings (non-member guests, more than 7 days in advance), a payment method is saved but not charged until the booking is confirmed approximately 7 days before check-in.</li><li>Annual membership subscriptions are invoiced separately through Xero and must be current to access member booking rates.</li><li>All prices are in {{currency}} inclusive of GST where applicable.</li><li>Payment processing is handled by Stripe. {{club-name}} does not store credit card details.</li></ul></div>`,
  `<div><h2>5. Non-Member Priority System</h2><p>The {{club-name}} is a members' club. Members have priority access to the lodge. The following rules apply to bookings that include non-member guests:</p><ul><li>Bookings including non-members made more than 7 days before check-in are held as &ldquo;Pending&rdquo;.</li><li>If a member booking requires capacity that a pending non-member booking occupies, the most recently made pending bookings are cancelled (&ldquo;bumped&rdquo;) until sufficient capacity is available.</li><li>Bumped bookings receive a full refund and immediate email notification.</li><li>{{club-name}} accepts no liability for costs incurred by guests (e.g. travel, equipment hire) as a result of a booking being bumped.</li></ul></div>`,
...
const faqContentHtml = [
  `<div class="website-legal-copy">`,
  `<div><h2>Booking &amp; Stays</h2><h3>How do I book a stay at the lodge?</h3><p>Members can book directly through this website. Log in, click "Book a Stay", select your dates and add your guests. The calendar shows available beds for each night. You'll need a current membership subscription to book at member rates.</p><h3>What is the cancellation policy?</h3><p>Refunds are tiered based on how much notice you give. Generally, cancellations 14 or more days before your stay receive a full refund. Between 7 and 14 days you receive a partial refund, and cancellations with less than 7 days' notice receive no refund. The exact tiers are set by the committee and shown on the Club Rules page. Always cancel as early as possible if your plans change.</p><h3>What are the nightly rates?</h3><p>Rates vary by season (Winter and Summer) and by age group (Adult, Youth, Child). Members pay a significantly lower rate than non-member guests. Current rates are shown on the Join page. Non-member guests must be accompanied by a financial member.</p><h3>Can I stay at the lodge as a non-member?</h3><p>Yes, but you must be invited as a guest by a current financial member, who must also be staying at the lodge during your visit. Non-member bookings are subject to a 7-day priority hold: if a member-only booking needs the beds within 7 days of your check-in date, your booking may be bumped. You'll receive immediate notification and a full refund if this happens.</p><h3>How does the non-member priority (bumping) system work?</h3><p>The lodge gives priority to member bookings. When you book as a guest more than 7 days in advance, your booking is held as "Pending" until 7 days before check-in. If a member needs those beds and the lodge is at capacity, the most recently made non-member bookings are bumped first to free up space. You'll be notified immediately by email and receive a full refund. This system ensures members always have access to the lodge they help maintain.</p><h3>Can I change my booking dates?</h3><p>Yes, members can change their booking dates from the booking detail page, subject to availability. A change fee may apply if you're modifying a booking within the late-notice period. The system will show you the fee before you confirm the change.</p></div>`,
  `<div><h2>Membership</h2><h3>How do I become a member?</h3><p>Membership is by nomination. You need to be nominated by two existing financial members. Start by visiting the lodge as someone's guest, get to know some members, and ask if they'd be willing to nominate you. See the Join page for the full process.</p><h3>What does membership cost?</h3><p>There is a one-off entrance fee for new members, plus an annual subscription. Subscriptions run April to March and are invoiced through Xero. Family memberships cover all household members at a reduced combined rate. Contact the Treasurer for current fee amounts.</p><h3>When does the membership year run?</h3><p>The membership year runs from 1 April to 31 March. Annual subscriptions are due at the start of each year. Members with unpaid subscriptions lose access to member booking rates until their subscription is paid.</p><h3>How do I reset my password?</h3><p>Click "Forgot password?" on the login page and enter your email address. You'll receive a password reset link valid for one hour. If you don't receive the email, check your spam folder or contact the Booking Officer.</p></div>`,
  `<div><h2>The Lodge</h2><h3>What facilities does the lodge have?</h3><p>Waldvogel Lodge at Iwikau Village, Mt Ruapehu sleeps up to {{lodge-capacity}} guests across 6 rooms. The lodge has a fully equipped communal kitchen, dining area, lounge, drying room, and ski storage. Bedding is provided. The lodge is accessible by 2WD vehicle in summer and requires 4WD or chains in winter snow conditions.</p><h3>What should I bring?</h3><p>Bring your own sleeping bag or hire one. The lodge provides pillows and mattresses. Pack warm clothing, appropriate footwear for the season, and any personal toiletries. If skiing, you can store your gear in the drying room. Check the weather forecast before your trip &mdash; conditions on the mountain can change quickly.</p><h3>How do chore rosters work?</h3><p>Every guest staying at the lodge is assigned a chore to help keep it clean and tidy. The hut leader for the night assigns chores (such as cleaning the kitchen, vacuuming, or tidying bathrooms) based on who is staying. You'll receive an email with your assigned chore. Chores are shared fairly and take around 15 to 30 minutes. It's how we keep lodge fees affordable for everyone.</p></div>`,
  `<div><h2>Privacy &amp; Account</h2><h3>What personal data does the club hold about me?</h3><p>The club holds your name, email address, phone number, date of birth, booking history, payment records, and chore assignments. This information is used to manage bookings and club membership. See our Privacy Policy for full details on how your data is collected, stored, and used.</p><h3>How do I update my personal details?</h3><p>Log in and go to your Profile page to update your name, phone number, and date of birth. To change your email address, use the "Change Email" section on your profile &mdash; you'll need to verify the new address. To change your password, use the "Change Password" option.</p></div>`,
