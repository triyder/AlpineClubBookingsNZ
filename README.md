...
| 📅 **Events calendar** — month view of club meetings and events, recurring events (incl. "3rd Tuesday of the month"), read-only for members, editable by committee and lodge admins → [guide](docs/guides/calendar.md) | 🎥 **Video meetings** — attach a self-hosted [MiroTalk](https://github.com/miroslavpejic85/mirotalk) meeting to a calendar event for committee calls → [guide](docs/guides/calendar.md#video-meetings-mirotalk) |
