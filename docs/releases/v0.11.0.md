...
Released 2026-07-13. This minor public reference release brings all changes
landed after `v0.10.1` into one supported tag. The canonical detailed entries
remain in `CHANGELOG.md`; this page is the release/operator overview.
...
- Portable Configuration Export & Import with dry-run, explicit matching,
  category selection, merge/overwrite modes, bundle integrity warnings, and a
  mandatory pre-apply database backup.
...
- The release contains 29 migrations. Twenty-five have explicit safety-ledger
