...
> **Automated coverage (issue #1568):** a `multi-lodge` Playwright project
> (`E2E_MULTI_LODGE=1`; see `docs/E2E_PLAYWRIGHT.md`; a blocking CI check since
> #1655) exercises a subset of the cross-lodge isolation
