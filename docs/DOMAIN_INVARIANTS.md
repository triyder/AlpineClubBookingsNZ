...
which remains an admin-controlled roster/coverage record and issues a one-time
lodge PIN. Assignment additionally requires the member to hold the standard
