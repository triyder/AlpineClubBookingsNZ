...
| Committee administration | Admin/member/public | Configure committee master roles, link members to roles, edit hidden-by-default assignment presentation flags, and publish privacy-controlled committee/contact records | High | Schema, migration/backfill, admin route, member detail, seed, audit, public API, contact route, and component tests | Targeted committee role/assignment API tests, seed defaults, member detail integration, public committee privacy tests, contact routing tests, and public committee/contact component tests |
