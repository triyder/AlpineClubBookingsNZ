...
export function MemberDetailHeader({
  ...
  return (
    <div>
      <Button variant="ghost" size="sm" className="mb-2 -ml-2" onClick={() => router.push(backHref)}>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            ...
            <Badge
              ...
              className={
                member.active ? "bg-green-100 text-green-800 hover:bg-green-200 border-green-200" : ""
              }
            >
        ...
        <div className="flex gap-2 shrink-0 flex-wrap">
          ...
          {member.xeroContactId ? (
            <>
              ...
              <Button variant="outline" size="sm" onClick={onUnlinkXero} disabled={xeroUnlinking}>
            ...
            <>
              ...
              <Button variant="outline" size="sm" onClick={onOpenCreateXero} disabled={xeroPushing}>
                <Plus className="h-4 w-4 mr-1" />
