...
export default function BookingPoliciesPage() {
  ...
  // Public booking request settings
  ...
  }, [fetchDefaults, fetchPeriods, fetchMinStay, fetchGroupDiscount, fetchBookingRequestSettings])
  ...
  if (loadingDefaults || loadingPeriods || loadingMinStay || loadingGroup || loadingBookingRequestSettings) {
