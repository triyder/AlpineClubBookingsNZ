...
export default function PrintRosterPage() {
  ...
  const byChore = new Map<
    string,
    {
      ...
      sortOrder: number;
      guests: Array<{ name: string; ageTier: string | null }>;
    }
  >();
      ...
      <div className="max-w-[800px] mx-auto p-8 print:p-0">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">
            {roster.guestCount} guest{roster.guestCount !== 1 ? "s" : ""}{" "}
            staying
          </p>
        </div>
        ...
        <table className="w-full border-collapse border border-gray-400 text-sm">
          <thead>
            <tr className="bg-gray-100">
              <th className="border border-gray-400 px-3 py-2 text-left w-8">
                #
              </th>
              <th className="border border-gray-400 px-3 py-2 text-left w-48">
                Chore
              </th>
        ...
        <div className="mt-6 p-3 border-2 border-gray-800 bg-yellow-50 text-center">
          <p className="font-bold text-sm">
            Last person to bed: Check heaters and fire are safe and doors are
            secure.
          </p>
        </div>
      </div>
